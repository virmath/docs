...
1.1 This User Agreement (hereinafter referred to as "this Agreement") is a legally binding agreement between you (hereinafter referred to as "User" or "you") and Guangxi Virmath Technology Studio (Sole Proprietorship) (hereinafter referred to as "we," "us," or "the Platform") regarding your use of Virmath Elf and related services (hereinafter referred to as "the Service") provided by the Platform.
...
Unless otherwise expressly defined in this Agreement, the following terms shall have the meanings set forth below:

2.1 **Virmath Elf**: The software tool provided by the Platform that enables script or program logic development through graphical node drag-and-drop, connections, and configuration, including its Web, desktop, mobile, and other versions.

2.2 **User Account**: The unique identity credential obtained by a User upon completing registration in accordance with the Platform's requirements, used to log in to and use the Service.

2.3 **Credits**: Virtual billing units that Users may obtain through payment purchases or other means and use to redeem subscription services within the Platform. Credits are not currency, are not withdrawable, transferable, or giftable.

2.4 **Subscription Service**: The entitlement to use specific advanced features or services of the Platform for a specified period, obtained by redeeming a certain number of Credits.

## 3. Account Registration and Management

### 3.1 Registration Requirements

3.1.1 You confirm that you are at least 18 years of age at the time of registration, or at least 14 years of age and using the Service under the supervision of a legal guardian. If you are under 14, you may not register for or use the Service.

3.1.2 You shall complete registration using true, accurate, and complete personal information, and ensure that such information remains valid throughout the term of your account. If your information changes, you shall update it promptly.

### 3.2 Account Security

3.2.1 You are fully responsible for the security of your registered account and password. **Any actions carried out through your account shall be deemed to have been performed by you personally.**
...
### 4.1 Obtaining Credits

4.1.1 Users may purchase Credits through the payment channels designated by the Platform (including but not limited to Alipay, WeChat Pay, bank cards, etc.). Different Credit packages correspond to different amounts, as specified on the purchase page.

4.1.2 Purchasing Credits constitutes your authorization for us to collect the corresponding payment through third-party payment platforms. Upon completion of payment, Credits will be credited to your account.

4.1.3 In addition to paid purchases, we may from time to time grant Credits through promotions, rewards, or similar means. The rules governing the use of such granted Credits shall be as specified on the relevant promotion page.

### 4.2 Use of Credits

4.2.1 **Credits may only be used to redeem Subscription Services provided by the Platform. They may not be exchanged for cash, physical goods, or other non-subscription services.**

4.2.2 When redeeming a Subscription Service with Credits, the specific number of Credits required shall be as posted on the Platform at the time of redemption. **Once the redemption is successful, the corresponding Credits will be deducted from your account and are non-refundable.**

4.2.3 **Credits may not be split or combined for use unless otherwise specifically stated by the Platform.**
...
### 5.1 Obtaining a Subscription

5.1.1 Users with sufficient Credit balances may use Credits to redeem corresponding Subscription Services. Upon redemption, the Subscription Service will take effect immediately or as otherwise agreed.

5.1.2 Different tiers of Subscription Services correspond to different features and durations, as specified on the Platform's relevant page.

### 5.2 Subscription Content

Principal subscription features may include, but are not limited to:

- Access to advanced node libraries
- Increased node usage limits
- Increased runtime instance limits
...
5.3.1 Subscription Services take effect for the term corresponding to each redemption and terminate automatically upon expiration.

5.3.2 To renew, Users must use Credits to redeem a renewal before the current subscription expires. **We do not undertake to send renewal reminder notices prior to expiration.**

5.3.3 **The Platform reserves the right to adjust the pricing of Subscription Services (i.e., the number of Credits required for redemption) based on operational circumstances. Adjusted prices shall apply to new redemptions occurring after the adjustment takes effect.**

### 5.4 Subscription Cancellation and Termination
...
6.1 You undertake to comply with all applicable laws and regulations of the People's Republic of China when using the Service, and you shall not use the Service for any illegal activities.

6.2 You shall not use this tool to develop, generate, or disseminate the following content:

- Content that violates laws, regulations, or public order and good customs;
- Content that infringes upon the intellectual property or other lawful rights of others;
- Malicious code, viruses, trojans, or other destructive programs;
...
10.1 The formation, performance, interpretation, and resolution of disputes under this Agreement shall be governed by the laws of the People's Republic of China.

10.2 Any dispute arising out of or in connection with this Agreement shall first be resolved through friendly negotiation between the parties. If negotiation fails, **either party may submit the dispute to a competent people's court in the jurisdiction where the Platform operator is domiciled.**

## 11. Miscellaneous

11.1 This Agreement constitutes the entire agreement between you and us regarding the use of the Service and supersedes any prior oral or written agreements on the same subject matter.

11.2 **If any provision of this Agreement is held to be invalid or unenforceable for any reason, the remaining provisions shall continue in full force and effect.**

11.3 Our failure to exercise or delay in exercising any right under this Agreement shall not constitute a waiver of such right.
